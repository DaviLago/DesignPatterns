...
public class JFrameGraficoView extends javax.swing.JFrame implements Observer {
   
    public JFrameGraficoView() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameGraficoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameGraficoView().setVisible(true);
            }
        });
    }
    ...
    public void update(Observable modelo, Object o1) {
        ProgressBar1.setValue(((Modelo) modelo).getNum1());
        ProgressBar2.setValue(((Modelo) modelo).getNum2());
        ProgressBar3.setValue(((Modelo) modelo).getNum3());
        ProgressBar4.setValue(((Modelo) modelo).getNum4());
        ProgressBar5.setValue(((Modelo) modelo).getNum5());
    }
}
